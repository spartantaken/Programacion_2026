...
int main() {
    ...
    Vehiculo veh1("Ford", "F-150", 2019, "tipo A (Particular)", "ABC-123");
    std::cout << "Vehiculo base:" << std::endl;
    veh1.mostrarInformacion();
    std::cout << std::endl;

    // Coche
    Coche coche1("Toyota", "Corolla", 2022, "Tipo A", "TOY-001", 1800, 4, 2);
    std::cout << "Coche 1:" << std::endl;
    coche1.mostrarInformacion();
    std::cout << std::endl;

    // Camion
    Camion camion1("Volvo", "FH16", 2020, "VOL-999", 4500, 4, 2);
    std::cout << "Camion 1:" << std::endl;
    camion1.mostrarInformacion();
    std::cout << std::endl;

    // Autobus
    Autobus bus1("Mercedes", "Sprinter", 2018,  "BUS-555", 2200, 3, 2, 50);
    std::cout << "Autobus 1:" << std::endl;
    bus1.mostrarInformacion();
    std::cout << std::endl;

    // MOTO - CORREGIDO: Conversión explícita a std::string
    Moto moto1("Honda", "CBR", 2021, "MOT-777", 1000, 2);
